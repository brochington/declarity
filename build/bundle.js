...
/***/ function(module, exports, __webpack_require__) {
	...
	var register = exports.register = function register(_ref) {
	    ...
	    var wrappedEntity = new _EntityWrapper2.default(entityClass, props, children);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _initialiseProps = function _initialiseProps() {
	    ...
	    this.mount = function (props, children) {
	        ...
	        // willMount
	        if (hasMethod('willMount', _this.entity)) {
	            _this.entity.willMount();
	        }

	        // didMount
	        if (hasMethod('didMount', _this.entity)) {
	            _this.entity.didMount();
	        }

	        // create
	        if (hasMethod('create', _this.entity)) {
	            var createdState = _this.entity.create();
	            // handle async stuff here.
	        }

	        // didCreate
	        if (hasMethod('didCreate', _this.entity)) {
	            _this.entity.didCreate();
	            // handle async stuff here.
	        }

	        // mount the children
	        if (hasMethod('render', _this.entity)) {
	            var renderContent = _this.entity.render();
	    ...
	    this.update = function () {
	        if (_this.childEntities) {
	            ...
	            var newContent = _this.entity.render();
	            ...
	            if ((0, _lodash.isEqual)(oldComponentNames, newComponentNames)) {
	                ...
	                _this.childEntities = zippedChildren.map(function (_ref2) {
	        ...
	        // willUpdate
	        if (hasMethod('willUpdate', _this.entity)) {
	            _this.entity.update();
	        }

	        // update
	        // The update process might be the "pipeline" that I've been thinking of.
	        if (hasMethod('update', _this.entity)) {
	        ...
	        // didUpdate
	        if (hasMethod('didUpdate', _this.entity)) {
	            _this.entity.didUpdate();
	        }
	    };
	};
