...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createEntity = __webpack_require__(113);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _EntityWrapper = __webpack_require__(27);
	...
	var register = exports.register = function register(_ref) {
	    ...
	    var wrappedEntity = new _EntityWrapper2.default(entityClass, props, children, {}, true);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _StateManager = __webpack_require__(77);
	...
	var hasMethod = function hasMethod(methodName, instance) {
	...
	var EntityInstance = function () {
	    function EntityInstance(entityClass, props, children, passedActions, isFirstInTree) {
	        var _this = this;
	        ...
	        if (entityClass.actions) {
	            ...
	            this.stateManager.init((0, _extends3.default)({}, passedActions, entityClass.actions), function () {
	                return {};
	            }, // initial state...
	...
	var _initialiseProps = function _initialiseProps() {
	    ...
	    this.mount = function (props, children) {
	        ...
	        // willMount
	        if (hasMethod('willMount', _this2.entity)) {
	            _this2.entity.willMount();
	        }

	        // didMount
	        if (hasMethod('didMount', _this2.entity)) {
	            _this2.entity.didMount();
	        }

	        // create
	        if (hasMethod('create', _this2.entity)) {
	            var createdState = _this2.entity.create();
	            // handle async stuff here.
	        }

	        // didCreate
	        if (hasMethod('didCreate', _this2.entity)) {
	            _this2.entity.didCreate();
	            // handle async stuff here.
	        }

	        // mount the children
	        if (hasMethod('render', _this2.entity)) {
	            var renderContent = _this2.entity.render();

	            if (renderContent && renderContent.length && renderContent.length > 0) {
	                _this2.childEntities = handleRenderContent(renderContent, _this2.stateManager.actions);
	    ...
	    this.update = function () {
	        if (_this2.childEntities) {
	            ...
	            var newContent = _this2.entity.render();
	            ...
	            if ((0, _lodash.isEqual)(oldComponentNames, newComponentNames)) {
	                ...
	                _this2.childEntities = zippedChildren.map(function (_ref2) {
	                    var _ref3 = (0, _slicedToArray3.default)(_ref2, 2);

	                    var oldChild = _ref3[0];
	                    var newChild = _ref3[1];

	                    var newProps = (0, _lodash.isNil)(newChild.props) ? {} : newChild.props;
	                    var newChildren = (0, _lodash.isArray)(newChild.children) ? (0, _lodash.flatten)(newChild.children) : [];

	                    oldChild.appState = _this2.entity.appState;
	                    oldChild.entityInstance.entity.appState = _this2.entity.appState;
	        ...
	        // willUpdate
	        if (hasMethod('willUpdate', _this2.entity)) {
	            _this2.entity.update();
	        }

	        // update
	        // The update process might be the "pipeline" that I've been thinking of.
	        if (hasMethod('update', _this2.entity)) {
	        ...
	        // didUpdate
	        if (hasMethod('didUpdate', _this2.entity)) {
	            _this2.entity.didUpdate();
	        }
	    };
